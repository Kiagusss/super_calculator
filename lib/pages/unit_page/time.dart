...
class _TimePageState extends State<TimePage> {
  ...
  String _selectedFromUnit = 'Second(s)';
  String _selectedToUnit = 'Second(s)';
...
// Function untuk menangani input tombol
  void _convertLength() {
    if (_isNumeric(_input)) {
      ...
      double result =
          convertTime(inputValue, _selectedFromUnit, _selectedToUnit);
      setState(() {
...
// Widget untuk membuat tombol kalkulator
  ...
  double convertTime(double value, String fromUnit, String toUnit) {
    ...
    switch (fromUnit) {
      ...
      case 'Year(year)':
        secondsValue =
            value * secondsInMinute * minutesInHour * hoursInDay * daysInYear;
        break;
    }
    ...
    switch (toUnit) {
      ...
      case 'Week(week)':
        result = secondsValue /
            (secondsInMinute * minutesInHour * hoursInDay * daysInWeek);
        break;
      case 'Month(month)':
        result = secondsValue /
            (secondsInMinute * minutesInHour * hoursInDay * daysInMonth);
        break;
      case 'Year(year)':
        result = secondsValue /
            (secondsInMinute * minutesInHour * hoursInDay * daysInYear);
        break;
    }
